...
class MapScreenState extends State<ProfilePage>
  ...
  Widget build(BuildContext context) {
   // DateTime todayDate = DateTime.parse(data_nascimentoUser);
                                ...
                                children: <Widget>[
                                  Flexible(
                                    child: Padding(
                                      ...
                                      child: new Text("$data_nascimentoUser"),
                                    ),
                                  ),
                                ],
                              )),
            ...
            child: Padding(
              ...
              child: Container(
                  child: new RaisedButton(
                    ...
                    onPressed: () {
                      setState(() {
                        Navigator.push(context, SlideRightRoute(page: EditProfilePage()));
                      });
                    },
